...
- Simulation: [https://dashboard.tenderly.co/me/simulator/a81092f6-6643-4dff-8d91-73c3fecb3645](https://dashboard.tenderly.co/me/simulator/a81092f6-6643-4dff-8d91-73c3fecb3645)
...
A proposal to lower the LT of TUSD to 77.5% and LTV to 75% on Aave V2 on Ethereum.

## Motivation

If the community views TUSD as having excess counterparty risk, this is a proposal to lower the LT and LTV of TUSD.

## Specification

Lower the LT of TUSD to 77.5% and LTV to 75% on Aave V2 on Ethereum.

## Implementation

The proposal implements changes on LT and LTV of TUSD on Aave V2 on Ethereum using the `configureReserveAsCollateral` method on the `LendingPoolConfigurator`.
