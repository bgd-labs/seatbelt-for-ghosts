...
- Simulation: [https://dashboard.tenderly.co/me/simulator/509cdbc2-401a-479b-b8b2-685c5fe4d03e](https://dashboard.tenderly.co/me/simulator/509cdbc2-401a-479b-b8b2-685c5fe4d03e)
...
Gauntlet recommends to freeze CRV and set CRV LTV -> 0 on Aave v2 Ethereum.

## Motivation

Gauntlet has been looking into the risk profile of 0x7a16ff8270133f063aab6c9977183d9e72835428. This account borrows roughly $63m of USDST against $190m of CRV, as of 2023/06/13. We recommend to 1. freeze CRV collateral and 2. set Curve LTV to 0, to prevent the account from continuing to add CRV and increasing concentration risk, due to the decrease in CRV liquidity over the past few months.

## Specification

Freeze CRV, set CRV LTV -> 0 on Aave v2 Ethereum.

## Implementation

The proposal implements changes on Aave v2 Ethereum using the `freezeReserve` and `configureReserveAsCollateral` methods of the `LendingPoolConfigurator`.
...
- Events Emitted:
  - InitializableImmutableAdminUpgradeabilityProxy at `0x311Bb771e4F8952E6Da169b425E7e92d6Ac45756` with implementation LendingPoolConfigurator at `0x3a95Ee42f080ff7289C8B4a14EB483a8644d7521`
    ...
    - `CollateralConfigurationChanged(asset: 0xd533a949740bb3306d119cc777fa900ba034cd52, ltv: 0, liquidationThreshold: 5800, liquidationBonus: 10800)`
