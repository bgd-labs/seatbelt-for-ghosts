...
- Targets: [0x7aa759A57c6b039A93e93683FacD14209EE9A3DD](https://etherscan.io/address/0x7aa759A57c6b039A93e93683FacD14209EE9A3DD#code); [0x158a6bC04F0828318821baE797f50B0A1299d45b](https://etherscan.io/address/0x158a6bC04F0828318821baE797f50B0A1299d45b#code)
- Executor: [0xEE56e2B3D491590B5b31738cC34d5232F378a8D5](https://etherscan.io/address/0xEE56e2B3D491590B5b31738cC34d5232F378a8D5) (Short executor)
- Simulation: [https://dashboard.tenderly.co/me/simulator/76395ca3-fa33-49ec-a560-a0a4594712d2](https://dashboard.tenderly.co/me/simulator/76395ca3-fa33-49ec-a560-a0a4594712d2)

### Subreports

- [Polygon](/reports/Aave/0xEC568fffba86c094cf06b22134B23074DFE2252c/288_Polygon_53.md)
...
Gauntlet recommends reducing the LT and LTV for CRV on V3 Ethereum and Polygon, as well as the debt ceiling for CRV on V3 Ethereum. For more details, see the full forum post [here](https://governance.aave.com/t/gauntlet-recommendation-to-lower-crv-lt-on-v3-ethereum-and-polygon/14302).

## Motivation

Given the declines in DEX liquidity for CRV and other associated risk factors for CRV, Gauntlet recommends reducing the LT and LTV for CRV on V3 Ethereum and Polygon, as well as the debt ceiling for CRV on v3 Ethereum.

## Specification

- Reduce CRV LT from 61% to 41%, LTV from 55% to 35%, debt ceiling from $20m to $5m on V3 Ethereum.
- Reduce CRV LT from 75% to 65% and LTV from 70% to 35% on V3 Polygon.

## Implementation

The proposal implements changes to CRV LT, LTV, and debt ceiling on V3 Ethereum and Polygon using the following pre-deployed payloads:

- Ethereum: [`0x7aa759a57c6b039a93e93683facd14209ee9a3dd`](https://etherscan.io/address/0x7aa759a57c6b039a93e93683facd14209ee9a3dd)
- Polygon: [`0xc12ad8b3d242b1eddc1c8319d1d58608e67043ed`](https://polygonscan.com/address/0xc12ad8b3d242b1eddc1c8319d1d58608e67043ed)
...
+ 3291009114642412084309944074109708748041569692484794015520083469698076076
...
- Events Emitted:
  - InitializableImmutableAdminUpgradeabilityProxy at `0x64b761D848206f447Fe2dd461b0c635Ec39EbB27` with implementation PoolConfigurator at `0xFDA7ffA872bDc906D43079EA134ebC9a511db0c2`
    - `CollateralConfigurationChanged(asset: 0xd533a949740bb3306d119cc777fa900ba034cd52, ltv: 3500, liquidationThreshold: 4100, liquidationBonus: 10830)`
    - `DebtCeilingChanged(asset: 0xd533a949740bb3306d119cc777fa900ba034cd52, oldDebtCeiling: 2090000000, newDebtCeiling: 500000000)`
  - StateSender at `0x28e4F3a7f651294B9564800b2D01f35189A5bFbE`
    - `StateSynced(id: 2743280, contractAddress: 0x8397259c983751daf40400790063935a11afa28a, data: )`
  - EthRobotKeeper at `0x7A9ff54A6eE4a21223036890bB8c4ea2D62c686b`
    - `ActionSucceeded(id: 288, action: 1)`
  - KeeperRegistry at `0x02777053d6764996e594c3E88AF1D58D5363a2e6`
    - `UpkeepPerformed(id: 70512291588073812442398021696698234047256200744984340334351949316371513751146, success: true, from: 0x0fd40853b3b8c7805158b862b76b35a2a27b596a, payment: 0, performData: )`
...
- Touched address:
  ...
  - 0x7aa759a57c6b039a93e93683facd14209ee9a3dd: Contract (verified) (AaveV3EthereumUpdate20230804Payload)
...
<details>
<summary>View warnings for AaveV3EthereumUpdate20230804Payload at `0x7aa759A57c6b039A93e93683FacD14209EE9A3DD`</summary>
...
<details>
<summary>Slither report for AaveV3EthereumUpdate20230804Payload at `0x7aa759A57c6b039A93e93683FacD14209EE9A3DD`</summary>
