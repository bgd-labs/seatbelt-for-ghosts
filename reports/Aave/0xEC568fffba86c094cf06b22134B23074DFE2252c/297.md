...
- Simulation: [https://dashboard.tenderly.co/me/simulator/8e5a600f-3759-4a4a-a2d7-e3cc198ab479](https://dashboard.tenderly.co/me/simulator/8e5a600f-3759-4a4a-a2d7-e3cc198ab479)
...
Gauntlet recommends freezing CRV collateral on Aave v2 to prevent the V2 market from continuing to add CRV and increasing concentration risk. For more details, see the full forum post [here](https://governance.aave.com/t/arfc-gauntlet-recommendation-on-freezing-crv-for-aave-v2-ethereum/14428).

## Motivation

Gauntlet's rationale for freezing CRV remains the same from the [freeze proposals](https://app.aave.com/governance/proposal/?proposalId=121) in November 2022, [freeze recommendations](https://governance.aave.com/t/gauntlet-recommendation-to-freeze-crv-and-set-crv-ltv-0-on-aave-v2/13644) and [rationale](https://governance.aave.com/t/gauntlet-recommendation-to-freeze-crv-and-set-crv-ltv-0-on-aave-v2/13644/41?u=gauntlet) in June and [recommendations](https://governance.aave.com/t/post-vyper-exploit-crv-market-update-and-recommendations/14214/4?u=gauntlet) post Vyper Exploit in August. The main consideration is the risk profile of 0x7a16ff8270133f063aab6c9977183d9e72835428.

## Specification

Freeze CRV on Aave v2 Ethereum.

## Implementation

The proposal freezes the CRV reserve using the `freezeReserve` method on the `LendingPoolConfigurator` contract for Aave v2 Ethereum.
...
- Events Emitted:
  ...
  - EthRobotKeeper at `0x9EEa1Ba822d204077e9f90a92D30432417184587`
    - `ActionSucceeded(id: 297, action: 1)`
  - KeeperRegistry at `0x02777053d6764996e594c3E88AF1D58D5363a2e6`
    - `UpkeepPerformed(id: 38708010855340815800266444206792387479170521527111639306025178205742164078384, success: true, from: 0x3824b7a9c6d4ea93456df9b07df4ffdb37ffbcbf, payment: 0, performData: )`
