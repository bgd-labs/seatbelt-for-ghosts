...
- Simulation: [https://dashboard.tenderly.co/me/simulator/b849bea8-f21c-4b3b-a681-dd9763683fa2](https://dashboard.tenderly.co/me/simulator/b849bea8-f21c-4b3b-a681-dd9763683fa2)
...
Gauntlet recommends setting CRV LTV -> 0 on Aave v2 Ethereum.

## Motivation

Gauntlet has been looking into the risk profile of 0x7a16ff8270133f063aab6c9977183d9e72835428. This account borrows roughly $54m of USDT against $158m of CRV, as of 2023/08/01. We recommend setting CRV LTV to 0 to help impede additional borrowing against existing CRV collateral due to the recent decrease in CRV liquidity.

## Specification

Set CRV LTV -> 0 on Aave v2 Ethereum.

## Implementation

The proposal modifies the LTV on CRV using the `configureReserveAsCollateral` method on the `LendingPoolConfigurator` contract for Aave v2 Ethereum.
...
- Events Emitted:
  - InitializableImmutableAdminUpgradeabilityProxy at `0x311Bb771e4F8952E6Da169b425E7e92d6Ac45756` with implementation LendingPoolConfigurator at `0x3a95Ee42f080ff7289C8B4a14EB483a8644d7521`
    - `CollateralConfigurationChanged(asset: 0xd533a949740bb3306d119cc777fa900ba034cd52, ltv: 0, liquidationThreshold: 5500, liquidationBonus: 10800)`
