...
- Simulation: [https://dashboard.tenderly.co/me/simulator/8e9a09d7-4f12-436f-90c0-7c065c9b7356](https://dashboard.tenderly.co/me/simulator/8e9a09d7-4f12-436f-90c0-7c065c9b7356)
...
@@ `_reserves` key `0x5979d7b546e38e414f7e9822514be443a4800529`.configuration.data @@
- 753997829085803822702081193685429432094637762026328
+ 753997829086738436136617462658564921433897379306328

# decoded configuration.data for key `0x5979d7b546e38e414f7e9822514be443a4800529` (symbol: wstETH)
...
@@ `_queuedActions` key `0x8884aa302b9a114f7d4a82254253621603d01a18c926889a376f029084662257` @@
- true
+ false
...
- "0x00000000000000000000000000000000000000000000000000000000010e4ceb"
+ "0x00000000000000000000000000000000000000000000000000000000010e5827"
@@ Slot `0xa9f6f085d78d1d37c5819e5c16c9e03198bd14e08cd1f6f8191bc6207b9e970b` @@
- "0x000000000000000000000000000000000000000000000000271d45337e1a29a2"
+ "0x000000000000000000000000000000000000000000000000271d5e9a2c4e21a2"
```
...
- Events Emitted:
  - InitializableImmutableAdminUpgradeabilityProxy at `0x8145eddDf43f50276641b55bd3AD95944510021E`
    - `SupplyCapChanged(asset: 0x5979d7b546e38e414f7e9822514be443a4800529, oldSupplyCap: 18750, newSupplyCap: 30000)`
  - ArbitrumBridgeExecutor at `0x7d9103572bE58FfE99dc390E8246f02dcAe6f611`
...
- Touched address:
  ...
  - 0x134c50556de1a83dd947c9460a58d8d60a289cea: Contract (verified) (AaveV3ArbwstETHCapsUpdates_20230703)
...
<details>
<summary>View warnings for AaveV3ArbwstETHCapsUpdates_20230703 at `0x134C50556dE1A83Dd947c9460a58d8d60a289CEa`</summary>

```
INFO:CryticCompile:'solc --standard-json --allow-paths /home/runner/work/seatbelt-for-ghosts/seatbelt-for-ghosts/crytic-export/etherscan-contracts/0x134c50556de1a83dd947c9460a58d8d60a289cea-AaveV3Eth1INCHListing_20230517_Payload' running
```
...
<details>
<summary>Slither report for AaveV3ArbwstETHCapsUpdates_20230703 at `0x134C50556dE1A83Dd947c9460a58d8d60a289CEa`</summary>

```
'solc --standard-json --allow-paths /home/runner/work/seatbelt-for-ghosts/seatbelt-for-ghosts/crytic-export/etherscan-contracts/0x134c50556de1a83dd947c9460a58d8d60a289cea-AaveV3Eth1INCHListing_20230517_Payload' running
Traceback (most recent call last):
  File "/home/runner/.local/lib/python3.10/site-packages/slither/__main__.py", line 814, in main_impl
    ) = process_all(filename, args, detector_classes, printer_classes)
